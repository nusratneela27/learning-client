        ...
        <div className='md:px-32 pt-16'>
            <Slider {...settings}>
                <div className='banner1 text-white ps-16'>
                    ...
                    <button className="btn btn-outline btn-primary border-0 border-b-4 bg-gradient-to-r from-slate-500 via-slate-400 to-amber-100 mt-4 text-black">Get Started</button>
                </div>
